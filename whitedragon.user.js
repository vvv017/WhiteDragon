...
// @version      4.4.1
// @description  Custom expression avatars for ChatGPT with streaming emotion switching, long-turn support, Project profiles, sticky positioning, and header customization.
...
`;
        ...
        async render() {
            ...
            panel.innerHTML = `
<div class="${CL.drag}" title="Drag to move · Double-click to center"><h2>White Dragon Avatar V4.4.1</h2><span class="${CL.hint}">⋮⋮ Drag · double-click to center</span></div>
